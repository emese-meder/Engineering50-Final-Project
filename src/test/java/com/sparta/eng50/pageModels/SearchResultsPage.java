...
public class SearchResultsPage extends AbstractPage {
    ...
    public DeliveryInformationPage navigateToDeliveryInformation(){
        webDriver.findElement(informationTable).findElement(By.linkText("Delivery")).click();
        return new DeliveryInformationPage(webDriver);
    }

    public TermsAndConditionsPage navigateToTermsAndConditions(){
        webDriver.findElement(informationTable).findElement(By.linkText("Terms and conditions of use")).click();
        return new TermsAndConditionsPage(webDriver);
    }

    public LegalNoticePage navigateToLegalNoticePage(){
        webDriver.findElement(informationTable).findElement(By.linkText("Legal Notice")).click();
        return new LegalNoticePage(webDriver);
    }

    public AboutUsPage navigateToAboutUsPage(){
        webDriver.findElement(informationTable).findElement(By.linkText("About us")).click();
